...
import static org.nanospark.beanmapping.common.exception.BeanMappingException.ConstantMessage.DUPLICATED_CONVERT_METHOD;
import static org.nanospark.beanmapping.common.exception.BeanMappingException.ConstantMessage.NOT_CONVERT_METHOD;
...
class ConverterUtils {
    ...
    static {
        ...
        try {
            convertMethod = Function.class.getDeclaredMethod("apply", Object.class);
